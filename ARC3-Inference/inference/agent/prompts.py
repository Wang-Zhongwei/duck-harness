...
GAME_PRIORS_ADDENDUM = (
    ...
    # "- Drop a prior as soon as the frames contradict it. If none of your priors hold, probe without assumptions until you understand the rules. A game's rules can look strange at first and only make sense once you are familiar with them.\n"
    ...
    "- As levels get harder, the goal becomes clearer, but planning gets harder and matters more: later levels add more components, and those components often influence each other. Look for the configuration that satisfies all of them at once and achieves the goal.\n"
)
