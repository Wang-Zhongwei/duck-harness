...
def duck_kaggle_setup_command(config: DuckKaggleVllmConfig | None = None) -> str:
    ...
    replacements = {
        ...
        "__LOCAL_ANALYZER_TRIM_LOW_WATER_TOKENS__": repr(os.environ.get("LOCAL_ANALYZER_TRIM_LOW_WATER_TOKENS", "0")),
        "__LOCAL_ANALYZER_CONTEXT_STEPS__": repr(os.environ.get("LOCAL_ANALYZER_CONTEXT_STEPS", "5")),
...
setup_env = {
    ...
    'LOCAL_ANALYZER_TRIM_LOW_WATER_TOKENS': __LOCAL_ANALYZER_TRIM_LOW_WATER_TOKENS__,
